...
| _Summary_ | Variables, assignments, expressions, basic types. |
| _TILE aspects_ | Test domain, test cases and test run TILE-ing is applied. |
| _Topics_ | Variables, assignments, expressions, basic types. |
| _Technology used_ | Python. |
| _Audience_ | CS1 |
| _Programming learning goals_ | Basic programming concepts, datatypes, file in-/output. |
| _Testing learning goals_ |  |
| _Prerequisites_ | None. |
| _Variants_ | Numerous options are possible, including porting to other programming languages. |
