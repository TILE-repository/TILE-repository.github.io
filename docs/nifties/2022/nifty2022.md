...
For example, using a set of pytests (e.g. in the file [`union_test.py`](union_test.py)), and a textfile containing the output of those pytests
(e.g. [`union_test_pytest_output.txt`](union_test_pytest_output.txt)), the final generated test report in Excel would be:
